  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa' }}>
      <form onSubmit={submit} style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 24, width: '100%', maxWidth: 420 }}>
        <h1 style={{ fontSize: 22, fontWeight: 600, marginBottom: 16 }}>Sign in</h1>
        ...
        <button style={{ width: '100%', background: '#1a73e8', color: '#fff', borderRadius: 6, padding: '10px 12px', border: 0 }}>Continue</button>
        <div style={{ marginTop: 16, fontSize: 14, color: '#64748b' }}>New here? <Link to="/register" style={{ color: '#1a73e8' }}>Create an account</Link></div>
      </form>
    </div>
  )
}
